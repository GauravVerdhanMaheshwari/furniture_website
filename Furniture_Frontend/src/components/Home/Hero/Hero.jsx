  ...
  return (
    <div className="bg-gray-100 flex mt-25">
      <div className="bg-gray-200 flex-1/5 flex flex-col justify-center items-end p-20">
        ...
        <button className="mt-6 px-5 py-2.5 rounded-xl bg-red-200 hover:bg-red-300 hover:scale-105 transition-all duration-300 text-black font-bold text-xl active:scale-95 active:bg-red-400">
          Shop Now !
        </button>
      </div>
