...
function Hero() {
  ...
  return (
    <section className="bg-[#FFE8D6] flex flex-col md:flex-row mt-20 sm:mt-15 min-h-[70vh]">
      ...
      <div className="w-full md:w-1/2 flex justify-center items-center min-h-[300px] md:min-h-0 sm:hidden">
        <img
          src="hero_img.webp"
